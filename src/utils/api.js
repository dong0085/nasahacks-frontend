...
const dummyArticle = {
	...
	tl_dr: 'Astronaut muscle loss in microgravity is significant, but targeted exercise and nutrition show promise for mitigation.',
	tags: ['space biology', 'microgravity', 'skeletal muscle', 'astronaut health'],
	key_terms: ['atrophy', 'resistance training', 'nutritional countermeasures', 'long-duration missions'],
	quotes: ['“Muscle mass decreased by an average of 18% after 6 months in microgravity.”', '“Resistance exercise showed the strongest correlation with recovery of muscle strength.”'],
	score: 0.873,
	rank: 1,
	reason: 'Chosen for its direct relevance to spaceflight health risks and its exploration of interventions, which aligns with research priorities in astronaut well-being.',
};

export const getRankedArticles = async (messages) => {
	try {
		if (USE_DUMMY) return [dummyArticle, dummyArticle, dummyArticle, dummyArticle, dummyArticle];
