      ...
      <div id="main-chat-box" className="rounded-2xl border border-[#2A3238] bg-[#1C2026] p-3 flex flex-col overflow-hidden">
        <header id="chat-header" className="mb-3 flex items-center justify-between gap-2 border-b border-[#2A3238] pb-3">
          ...
          <span className="inline-flex items-center gap-2 rounded-full border border-[#2A3238] px-3 py-1 text-[11px] text-[#9AA4AB]">
            <span
              className={`h-2 w-2 rounded-full ${loading ? 'bg-[#379DA6] animate-pulse' : 'bg-[#38F8AC]'}`}
            />
            Live
          </span>
        </header>
        ...
        <div id="mobile-references" className="mt-4 rounded-2xl border border-[#2A3238] bg-[#161B21] p-4 lg:hidden">
          <div className="mb-2 flex items-center justify-between">
            ...
            <button
              ...
              onClick={fetchArticles}
              disabled={loading}
              className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-[#2A3238] text-[#E6E8EA] hover:border-[#379DA6] hover:text-[#379DA6] disabled:opacity-40"
